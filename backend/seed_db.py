...
def seed():
    ...
    products_data = [
        # Cookware - Steel
        {
            'name': 'Stainless Steel Pressure Cooker 5L', 'slug': 'stainless-steel-pressure-cooker-5l',
        ...
        {
            'name': 'Stainless Steel Kadai with Lid', 'slug': 'stainless-steel-kadai-with-lid',
        ...
        {
            'name': 'Steel Tope Set (3 Pieces)', 'slug': 'steel-tope-set-3-pieces',
        ...
        # Cookware - Non-stick
        {
            'name': 'Non-Stick Dosa Tawa 28cm', 'slug': 'non-stick-dosa-tawa-28cm',
        ...
        # Cookware - Cast iron
        {
            'name': 'Cast Iron Skillet 10 Inch', 'slug': 'cast-iron-skillet-10-inch',
        ...
        # Pooja
        {
            'name': 'Brass Pooja Thali Set', 'slug': 'brass-pooja-thali-set',
        ...
        {
            'name': 'Copper Pooja Lota', 'slug': 'copper-pooja-lota',
        ...
        # Cutlery
        {
            'name': 'Stainless Steel Spoon Set (12 Pieces)', 'slug': 'stainless-steel-spoon-set-12-pieces',
        ...
        # Dinnerware
        {
            'name': 'Stainless Steel Dinner Set (24 Pieces)', 'slug': 'stainless-steel-dinner-set-24-pieces',
        ...
        # Storage
        {
            'name': 'Airtight Storage Container Set (5 Pieces)', 'slug': 'airtight-storage-container-set-5-pieces',
        ...
        # Household
        {
            'name': 'Stainless Steel Water Bottle 1L', 'slug': 'stainless-steel-water-bottle-1l',
        ...
        # Stoves
        {
            'name': '3-Burner Gas Stove', 'slug': '3-burner-gas-stove',
        ...
        # Extra Cookware
        {
            'name': 'Aluminium Idli Maker 4-Plate', 'slug': 'aluminium-idli-maker-4-plate',
        ...
        {
            'name': 'Copper Bottom Handi 3L', 'slug': 'copper-bottom-handi-3l',
        ...
        # Extra Stoves
        {
            'name': 'Mixer Grinder 750W', 'slug': 'mixer-grinder-750w',
